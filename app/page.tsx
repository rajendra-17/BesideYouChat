...
export default async function Home() {
  ...
  if (session) {
    return (
      <>
        <Header />
        <div className={styles.blur} style={{ overflowY: "auto", height: "calc(100vh)" }}>
    ...
    return (
      <>
        <Header />
        <div className={styles.back} style={{ overflowY: "auto", height: "calc(100vh - 0px)" }}>
          <main className={styles.main}>
            <h1>Welcome to BesideYouChat</h1>
            <p>powered by I'mbesideyou Inc., Tokyo</p>
            {/* <SearchUsersHomePage /> */}
          </main>
        </div>
      </>
